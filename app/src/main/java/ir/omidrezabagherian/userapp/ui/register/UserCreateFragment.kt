package ir.omidrezabagherian.userapp.ui.register
...
import ir.omidrezabagherian.userapp.databinding.FragmentUserCreateBinding
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        userCreateBanding.buttonSend.setOnClickListener {
            ...
            viewModel.user.observe(viewLifecycleOwner) { user ->
                navController.navigate(UserCreateFragmentDirections.actionUserCreateFragmentToUploadImageFragment(user))
            }
